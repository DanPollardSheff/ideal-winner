...
PSA_strat <- "S88_S1" #Option to make sure that each instance only runs one set of PSAs, as it is computationally intensive
...
#settings for MATTS phase 1 where first 1000 runs 26090100 (after generating pat chars), next 1000 runs (ten diagnostic strategies only) 1346

date <- "_2_75_ben_ISS_u9" #name to append to saved files 
