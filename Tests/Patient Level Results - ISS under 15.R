...
write.csv(P2_WMAS, "Results/Phase 2 WMAS patlevel ISS under 15.csv")
write.csv(P3_WMAS, "Results/Phase 3 WMAS patlevel ISS under 15.csv")
write.csv(SWAST, "Results/Phase 2 SWAST patlevel ISS under 15.csv")
write.csv(LAS, "Results/Phase 2 LAS patlevel ISS under 15.csv")
