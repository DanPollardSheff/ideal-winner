...
WMAS_Step4 <- run_simulation(pat_chars, parameters, PSA_numb, "manual",0.91,0.25, 1)
...
MATTS_sens <- run_simulation(pat_chars, parameters, PSA_numb, "manual", 0.70,0.74, 1)
write.csv(MATTS_sens, "\\\\uosfstore.shefuniad.shef.ac.uk\\shared\\ScHARR\\PR_MATTS\\General\\Health Economics\\July 21\\MATTS_sens_ISSo16.csv")
MATTS_bal <- run_simulation(pat_chars, parameters, PSA_numb, "manual",0.57, 0.85, 1)
write.csv(MATTS_bal, "\\\\uosfstore.shefuniad.shef.ac.uk\\shared\\ScHARR\\PR_MATTS\\General\\Health Economics\\July 21\\MATTS_bal_ISSo16.csv")
field_triage <- run_simulation(pat_chars, parameters, PSA_numb, "manual", 0.48, 0.86, 1)
write.csv(field_triage, "\\\\uosfstore.shefuniad.shef.ac.uk\\shared\\ScHARR\\PR_MATTS\\General\\Health Economics\\July 21\\field_triage_ISSo16.csv")
oregon <- run_simulation(pat_chars, parameters, PSA_numb, "manual",0.44, 0.90,1)
write.csv(oregon, "\\\\uosfstore.shefuniad.shef.ac.uk\\shared\\ScHARR\\PR_MATTS\\General\\Health Economics\\July 21\\oregon_ISSo16.csv")
MATTS_spec <- run_simulation(pat_chars, parameters, PSA_numb, "manual", 0.38, 0.94,1)
write.csv(MATTS_spec, "\\\\uosfstore.shefuniad.shef.ac.uk\\shared\\ScHARR\\PR_MATTS\\General\\Health Economics\\July 21\\MATTS_spec_ISSo16.csv")
SWAST <- run_simulation(pat_chars, parameters, PSA_numb, "manual", 0.34, 0.94,1)
write.csv(SWAST, "\\\\uosfstore.shefuniad.shef.ac.uk\\shared\\ScHARR\\PR_MATTS\\General\\Health Economics\\July 21\\SWAST_ISSo16.csv")
TTR <- run_simulation(pat_chars, parameters, PSA_numb, "manual", 0.27, 0.95, 1)
write.csv(TTR, "\\\\uosfstore.shefuniad.shef.ac.uk\\shared\\ScHARR\\PR_MATTS\\General\\Health Economics\\July 21\\TTR_ISSo16.csv")
pre_hosp_index <- run_simulation(pat_chars, parameters, PSA_numb, "manual", 0.20, 0.96, 1)
write.csv(pre_hosp_index, "\\\\uosfstore.shefuniad.shef.ac.uk\\shared\\ScHARR\\PR_MATTS\\General\\Health Economics\\July 21\\pre_hosp_index_ISSo16.csv")
None <- run_simulation(pat_chars, parameters, PSA_numb, "manual", 0, 1, 1)
write.csv(None, "\\\\uosfstore.shefuniad.shef.ac.uk\\shared\\ScHARR\\PR_MATTS\\General\\Health Economics\\July 21\\None_ISSo16.csv")
