...
MATTS_sens <- run_simulation(param_data_bc, 1, PSA_numb, pat_numb, "manual", 0.70,0.74, 1)
...
MATTS_bal <- run_simulation(param_data_bc, 1, PSA_numb, pat_numb, "manual",0.57, 0.85, 1)
...
field_triage <- run_simulation(param_data_bc, 1, PSA_numb, pat_numb, "manual", 0.48, 0.86, 1)
...
oregon <- run_simulation(param_data_bc, 1, PSA_numb, pat_numb, "manual",0.44, 0.90,1)
...
MATTS_spec <- run_simulation(param_data_bc, 1, PSA_numb, pat_numb, "manual", 0.38, 0.94,1)
...
None <- run_simulation(param_data_bc, 1, PSA_numb, pat_numb, "manual", 0, 1, 1)
