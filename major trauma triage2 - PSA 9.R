...
if(PSA_switch==1){
  #sens_100_spec_10_PSA <- run_simulation(param_data_bc, 1, PSA_numb, 10000, "manual", 1, 0.1,1)
  ...
  #sens_0_spec_90_PSA <- run_simulation(param_data_bc, 1, PSA_numb, 10000, "manual", 0, 0.9,1)
