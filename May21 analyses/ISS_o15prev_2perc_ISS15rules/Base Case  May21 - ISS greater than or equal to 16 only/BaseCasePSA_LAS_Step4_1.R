...
LAS_Step4_PSA <- run_simulation(param_data_bc, 1, PSA_numb, pat_numb, "manual", 0.932, 0.252,1)
write.csv(LAS_Step4_PSA, paste(file_location,"PSA results\\May21\\LASstep4_ISSu16",date,".csv", sep=""))
