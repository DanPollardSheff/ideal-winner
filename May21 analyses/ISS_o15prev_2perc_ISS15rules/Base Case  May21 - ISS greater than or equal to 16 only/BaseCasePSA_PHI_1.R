...
trauma_score_PSA <- run_simulation(param_data_bc, 1, PSA_numb, pat_numb, "manual",  0.205, 0.955,1)
write.csv(trauma_score_PSA, paste(file_location,"PSA results\\May21\\PHI_ISSu16",date,".csv", sep=""))
