...
trauma_score_PSA <- run_simulation(param_data_bc, 1, PSA_numb, pat_numb, "manual",  0.92, 0.268,1)
write.csv(trauma_score_PSA, paste(file_location,"PSA results\\May21\\YAS_ISSu16",date,".csv", sep=""))
