...
New_LAS_PSA <- run_simulation(param_data_bc, 1, PSA_numb, pat_numb, "manual", 0.50, 0.88,1)
write.csv(New_LAS_PSA, paste(file_location,"PSA results\\May21\\NewLAS",date,".csv", sep=""))
