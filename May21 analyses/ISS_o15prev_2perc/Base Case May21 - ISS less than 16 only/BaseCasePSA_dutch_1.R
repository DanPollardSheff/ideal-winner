...
Dutch_PSA <- run_simulation(param_data_bc, 1, PSA_numb, pat_numb, "manual", 0.46, 0.90,1)
write.csv(Dutch_PSA, paste(file_location,"PSA results\\May21\\Dutch",date,".csv", sep=""))
