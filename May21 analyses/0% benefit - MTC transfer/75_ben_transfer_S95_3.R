...
PSA_rand_no <-  330413              #random number to determine PSA parameters either -99 (to not reset the seed) or any positive number

date <- "_3_75_ben_trans"          #name to append to saved files 
