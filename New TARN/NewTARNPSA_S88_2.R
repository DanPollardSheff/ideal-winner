...
TARN_mort_eq <- "New" # options are new or old. Default is old
MTCs_in_mort_risk <- "Yes" #options are Yes or no. Relates to whether the mort eq is a composite risk score for a 
