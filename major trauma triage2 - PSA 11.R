...
if(PSA_switch==1){
  #sens_100_spec_10_PSA <- run_simulation(param_data_MTCs, 1, PSA_numb, 10000, "manual", 1, 0.1,1)
  #write.csv(sens_100_spec_10_PSA, "PSA results\\sens_100_spec_10_PSA.csv")
  
  
  sens_0_spec_90_PSA <- run_simulation(param_data_MTCs, 1, PSA_numb, 10000, "manual", 0, 0.9,1)
  write.csv(sens_0_spec_90_PSA, "K:\\GitHub\\fantastic-lamp\\Major Trauma Triage v2\\PSA\\MTC v no MTC\\sens_0_spec_90_PSA.csv")
